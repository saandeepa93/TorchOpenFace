...
#ifndef TORCHFEATUREEXTRACTION_H
#define TORCHFEATUREEXTRACTION_H

namespace TorchFaceAnalysis{

  class TorchFeatureExtraction:public torch::CustomClassHolder {
    public:
      TorchFeatureExtraction(std::vector<std::string> arguments, const c10::Dict<std::string, c10::IValue>& misc_args);
      c10::Dict<std::string, torch::Tensor> ExtractFeatures(torch::Tensor img, c10::Dict<std::string, c10::IValue> ex_args);
      void SetImageParams(torch::Tensor img);
